" ~/.vim/sessions/hw6.vim:
" Vim session script.
" Created by session.vim 2.6.4 on 07 October 2014 at 16:49:32.
...
badd +109 app/assets/stylesheets/custom.css.scss
badd +1 config/routes.rb
badd +3 app/views/static_pages/home.html.erb
badd +5 app/views/layouts/_header.html.erb
badd +2 ~/School/CS1410/hw6.cpp
badd +27 ~/School/CS1410/hw6.h
badd +5 ~/School/CS1410/hw6_main.cpp
args Gemfile
edit ~/School/CS1410/hw6.cpp
...
setlocal fen
silent! normal! zE
let s:l = 56 - ((17 * winheight(0) + 27) / 55)
...
wincmd w
argglobal
edit ~/School/CS1410/hw6_main.cpp
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
